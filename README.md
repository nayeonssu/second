...
### 유효성 검사 오류잡기 TIP
* 유효성 검사 시 전체 오류 개수를 보지 말고 가장 윗 줄 에러부터 확인 후 고치기
...
* 사이트명에는 광고문구가 같이 들어갈 수 있다. : 깊이 빠져들다 CGV 등등...
...
`br태그`는 강제줄바꿈을 모바일~태블릿~PC까지 반응하는 반응형웹에 적합하지 않기 때문에 사용 시에는 글자 수가 적은 제목이나 배용 위주로 꼭 필요한 경우에만 사용한다.